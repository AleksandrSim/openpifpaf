...
#    image = cv2.resize(image, (input_width, input_height))
    ...
    predictor = Predictor(checkpoint='shufflenetv2k16', visualize_image=True, visualize_processed_image=True, onnx_weights=export_path)# onnx=r'D:\markerless-mocap\weights\openpifpaf_onnx_converted_3793_1585.onnx')# onnx=r'C:\Users\asimonyan\Desktop\open_pif_paf\experiments\shuflnet2kv30\epo.epoch22.onnx')#onnx=r'C:\Users\asimonyan\Desktop\open_pif_paf\experiments\shuflnet2kv30\epo.epoch22.onnx')
...
if __name__ == '__main__':
    checkpoint_path = r'C:\Users\asimonyan\markerless-mocap\weights\openpifpaf.ckpt'
    export_path = r'C:\Users\asimonyan\Desktop\openpifpaf_development_files\openpifpaf_onnx_converted_3793_1585.onnx'
    image_path = r'C:\Users\asimonyan\Desktop\openpifpaf_development_files\cam_9.png'
    target_sizes = [3793, 1585]
    predict_single(image_path, checkpoint_path, onnx=False, input_width=target_sizes[0], input_height=target_sizes[1], export_path=export_path, prune=None)
